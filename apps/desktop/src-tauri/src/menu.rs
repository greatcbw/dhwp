...
pub fn install(app: &mut App) -> tauri::Result<()> {
    let app_about = MenuItemBuilder::with_id("file:about", "About hwpdocx").build(app)?;
    let app_quit = MenuItemBuilder::with_id("app:quit", "Quit hwpdocx")
    ...
    let app_menu = SubmenuBuilder::new(app, "hwpdocx")
        .item(&app_about)
        .separator()
        .services()
        .separator()
